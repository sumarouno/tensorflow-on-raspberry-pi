...
int main(int argc, char* argv[]) {
  ...
  long int sms = stp.tv_sec * 1000 + stp.tv_usec / 1000;
  // END OF MODIFICATION
  ...
  long int mms = mtp.tv_sec * 1000 + mtp.tv_usec / 1000;
  // END OF MODIFICATION
  ...
  long int ems = etp.tv_sec * 1000 + etp.tv_usec / 1000;
  // END OF MODIFICATION
  ...
  // MODIFICATION BY SAM ABRAHAMS
  long int graph_time = mms - sms;
  long int eval_time = ems - mms;

  printf ("%d milliseconds to build graph\n", graph_time);
  printf ("%d milliseconds to evaluate image\n", eval_time);
  // END OF MODIFICATION
